...
main(String args[])
{
	(new ViewImgOpsPanel()).setVisible(true);
}
*/
...
buildGui()
{
	...
	add(BorderLayout.CENTER, imgsPanel);
	...
	*/
	...
	readImgBt.addActionListener(new ActionListener()
	{
		...
		{
			int returnVal =
				imgFileChooser.showOpenDialog(ViewImgOpsPanel.this);
...
throws Exception
{
	...
	/*
	fromImg = ImageApps.makeTextButtonImage(300, 100,
		"Test",
		20, 50, 0,
	...
	*/
/*
int imgW, int imgH, String btText,
...
extends java.awt.event.WindowAdapter
{
	public void windowClosing(java.awt.event.WindowEvent event)
	{
		...
		if (object == ViewImgOpsPanel.this)
